            ...
            <div>
              ...
              <p className="text-gray-900 mt-1">
                {typeof product.categoryId === 'string' 
                  ? product.categoryId 
                  : (product.categoryId as any)?.name || 'Not specified'}
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-900 mt-1">
                {typeof product.subCategoryId === 'string' 
                  ...
                  : (product.subCategoryId as any)?.name || 'Not specified'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-900 mt-1 font-mono text-sm">{product.id}</p>
          </div>
